...
#                              <<< SOME NOTES >>>                               #
#                                                                               #
#>>> This script prepares the spatial and temporal subsets of the S5P RPRO (L3) # 
...
class handleS5Pl3(): 
    ...
    def makeSpatialSubset(self):
        ...
        if os.path.exists(self.indir):       
            files = os.path.join(self.indir, "S5P_RPRO_L3__AER_AI_*.nc") 
        ...
        for count, file in enumerate(infiles):
            ...
            if nan_pernentage <= self.max_nans:
                ...
                date = str(file).split("_")[9].replace("T", " ") 
...
df_dir = "C:/Users/Reza/Desktop/Deniz_data/Deniz_new_data/"
